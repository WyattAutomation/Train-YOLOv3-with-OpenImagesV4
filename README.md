...
Note that the correct command below uses "downloader" and not "download" like the documentation on the OIDv4 GitHub erroneously states (3/7/19 they actually fixed that in the readme since I originally posted this).  Also note, if there is a space in the class name like "Human head" type it like "Human_head" below:
```
